...
const navItems = [
  ...
  { to: '/papas', label: 'Papás', icon: (active: boolean) => (
    <svg className={`h-5 w-5 ${active ? 'text-[#2d1b69]' : 'text-[#4b5563]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A4 4 0 017 10h10a4 4 0 011.879 7.804M9 10V8a3 3 0 116 0v2m-8 8h10a2 2 0 002-2v-1a3 3 0 00-3-3H8a3 3 0 00-3 3v1a2 2 0 002 2z" />
    </svg>
  ) },
  ...
  { to: '/asistencia-papas', label: 'Asistencia Papás', icon: (active: boolean) => (
    <svg className={`h-5 w-5 ${active ? 'text-[#2d1b69]' : 'text-[#4b5563]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l2.5 2.5M6 21h12a2 2 0 002-2v-6a8 8 0 10-16 0v6a2 2 0 002 2z" />
    </svg>
  ) },
  ...
  { to: '/planes-papas', label: 'Planes Papás', icon: (active: boolean) => (
    <svg className={`h-5 w-5 ${active ? 'text-[#2d1b69]' : 'text-[#4b5563]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 6h8M8 10h8M8 14h5m-7 7h12a2 2 0 002-2V5a2 2 0 00-2-2H6a2 2 0 00-2 2v14a2 2 0 002 2z" />
    </svg>
  ) },
];
